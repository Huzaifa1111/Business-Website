    ...
    <div className="flex gap-0.5" aria-label={`${rating} out of 5 stars`} role="img">
      {Array.from({ length: 5 }).map((_, i) => (
        <svg
          ...
          stroke={i < rating ? accentColor : "currentColor"}
          strokeWidth="1.2"
          className={i < rating ? "" : "text-neutral-300"}
          aria-hidden="true"
        >
              ...
              >
                ...
                <footer className="mt-6 flex items-center gap-3 pt-5 border-t border-neutral-100">
                  ...
                  <div
                    ...
                    style={{
                      background: `linear-gradient(135deg, ${accentColor}, var(--color-primary-${[800, 700, 900][i % 3]}))`,
                    }}
                    aria-hidden="true"
                  >
